...
export const mutations = {
	...
	async updateUserInfo(data = false) {
		console.log('updateUserInfo中的data', data);
		if (data) {
			...
			try {
				// console.log("读取用户表中数据");
				let res = await usersTable.where("'_id' == $cloudEnv_uid").field(
						'_id,addressBooks,avatar,mobile,nickname,username,private_phones')
					.get()
				// console.log("$cloudEnv_uid:", $cloudEnv_uid)
				// console.log('uni-id-pages中用户信息:', res.result.data);
